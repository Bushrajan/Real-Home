...
import { FaBath, FaVectorSquare } from "react-icons/fa6";
      ...
      <div className="relative">
        <div className="relative overflow-hidden lg:py-40 py-10 md:py-30 lg:px-0 md:px-10 px-5
          ...
          <motion.h1
            ...
            dynamic properties for sale ka name aai ga yahn
          </motion.h1>
        </div>
          ...
          <div className="flex-1 w-full space-y-6">
            ...
            <div className="bg-white shadow rounded-lg p-6">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                {
                  Posts && (
                    <button className="flex items-center gap-2 bg-white border border-blue-400 text-blue-400 px-4 py-2 rounded hover:bg-blue-400 hover:text-white transition"
                    >
                      <FaHeart />
                      Add to Favorites
                    </button>
            ...
            {/* Map */}
            {/* <div className="bg-white shadow rounded-lg p-6">
              <h3 className="text-2xl mb-2 text-blue-400">Property on Map</h3>
          ...
          <div className=" mx-auto lg:px-4 py-5 flex lg:flex-row  flex-wrap justify-center items-center  gap-5">
            ...
            {agents.map((agent, index) => (
              <motion.div
                ...
                className="relative lg:w-[400px] bg-white lg:h-[500px] border border-gray-100 text-center h-[auto] w-[300px] lg:py-10 py-4 rounded-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 group"
              >
                ...
                <div className="p-4">
                  ...
                  <div
                    className="mt-4 flex-col flex  text-[#0054A5] font-semibold"
                  >
                    <span className="lg:text-[25px] text-[15px] text-[#1CB2FF] transition-colors duration-300">{agent.listed}</span>

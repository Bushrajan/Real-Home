    ...
    <div className="">
      ...
      <div className="max-w-6xl md:mb-20 mb-10 mx-auto grid grid-cols-1 md:gap-0 gap-8 md:grid-cols-2 md:px-6 px-2 md:py-12 " data-aos="fade-up" data-aos-duration="1500">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full bg-[#1CB2FF] border text-white font-semibold py-3 rounded hover:shadow-lg transition-shadow duration-300 group flex justify-center z-10 items-center gap-2   text-sm  hover:bg-[white] hover:text-[#041C33] px-5 "
          >
            Submit Now
            <svg
